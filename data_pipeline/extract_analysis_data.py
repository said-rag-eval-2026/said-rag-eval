...
DATASETS   = ["HotpotQA", "MSMARCO", "WikiQA", "PubMedQA", "FinQA", "LegalRAG"]
GENERATORS = ["claude-sonnet-4-6", "gpt-5", "gemini-2.5-pro", 
              "Llama-3.1-8B-Instruct", "Qwen3-8B", "gemini-2.5-flash", "claude-haiku-4-5", "gpt-5-mini"]
JUDGES     = ["claude-sonnet-4-6", "gpt-5", "gemini-2.5-pro","gemini-2.5-flash", "claude-haiku-4-5", "gpt-5-mini"]
